  ...
  return (
    <div className=" w-[1540px]   h-[90px]  ">
        ...
        <div className=" my-[30px] mx-[30px] flex gap-5 items-center ">
          ...
          <div className={`text-3xl  ${!open && 'hidden'} duration-300 text-text-hover-color text-5xl font-semibold`}> Admin </div>
        </div>
           <div className='flex item-center my-8 mx-2 text-text-hover-color font-bold text-2xl'>
            Hello , User 
           </div>

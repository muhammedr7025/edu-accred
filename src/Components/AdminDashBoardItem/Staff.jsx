...
const Staff = () => {
  ...
  const [tableData, setTableData] = useState([
    { id: 1, name: 'Anup Mathew Abraham', department: 'CSE', role: 'HOD', email: 'gmail' },
    { id: 2, name: 'Shinu Mamachan', department: 'CSE', role: 'Asst. Professor', email: 'gmail' },
    { id: 2, name: 'Divya Susan Mathew', department: 'CSE', role: 'Asst. Professor', email: 'gmail' },
    { id: 2, name: 'Jasmine Paul', department: 'CSE', role: 'Asst. Professor', email: 'gmail' },
    { id: 2, name: 'Jasmine Paul', department: 'CSE', role: 'Asst. Professor', email: 'gmail' },
    { id: 2, name: 'Immanuel Thomas', department: 'CSE', role: 'Asst. Professor', email: 'gmail' },
    // ... other staff data
  ]);
